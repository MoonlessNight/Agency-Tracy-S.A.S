...
const personasInput = document.getElementById("personas") as HTMLInputElement;

// Elementos para mostrar los valores individuales por persona
const valorTiqueteInput = document.getElementById("valorTiquete") as HTMLInputElement;
const valorComidasInput = document.getElementById("valorComidas") as HTMLInputElement;
const valorAlojamientoInput = document.getElementById("valorAlojamiento") as HTMLInputElement;

// Elementos para mostrar los totales multiplicados por el número de personas
const totalTiqueteInput = document.getElementById("totalTiquete") as HTMLInputElement;
const totalComidasInput = document.getElementById("totalComidas") as HTMLInputElement;
const totalAlojamientoInput = document.getElementById("totalAlojamiento") as HTMLInputElement;

// Elementos para mostrar los cálculos finales
const descuentoInput = document.getElementById("descuento") as HTMLInputElement;
const subtotalInput = document.getElementById("subtotal") as HTMLInputElement;
const totalPagoInput = document.getElementById("totalPago") as HTMLInputElement;

// Elementos para los controles de la interfaz
const calcularBtn = document.getElementById("calcular") as HTMLButtonElement;
const efectivoRadio = document.getElementById("efectivo") as HTMLInputElement;
const creditoRadio = document.getElementById("credito") as HTMLInputElement;

// =================== DATOS DE PRECIOS POR CIUDAD ===================
// Objeto que contiene los precios base para cada ciudad
const valoresPorCiudad = {
    Armenia: { 
...
function calcularValores() {
    ...
    const valores = valoresPorCiudad[ciudad as keyof typeof valoresPorCiudad];
    if (!valores) return;  // Si no hay valores para la ciudad, terminamos
    ...
    const totalTiquete = valores.tiquete * numPersonas;
    const totalComidas = valores.comidas * numPersonas;
    const totalAlojamiento = valores.alojamiento * numPersonas;
    ...
    const subtotal = totalTiquete + totalComidas + totalAlojamiento;
    ...
    let totalPago = subtotal - descuento;
